...
public class Track extends AppCompatActivity {
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            String[] params = new String[]{Double.toString(mCurrentLocation.getLatitude()), Double.toString(mCurrentLocation.getLongitude()), android_id};
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(Track.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(Track.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
